...
# ACDS 23.4 79 win32 2024.02.13.12:01:39
# ----------------------------------------
...
alias file_copy {
  ...
  set normalized_src [alt_mge_core_pll::normalize_path "$file"]
  set normalized_dest [alt_mge_core_pll::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [alt_mge_core_pll::get_dpi_libraries "$QSYS_SIMDIR"]]
