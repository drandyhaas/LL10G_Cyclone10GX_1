...
# ----------------------------------------
# ACDS 23.4 79 win32 2024.02.13.11:57:53
...
alias file_copy {
  ...
  set normalized_src [alt_usxgmii_phy::normalize_path "$file"]
  set normalized_dest [alt_usxgmii_phy::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [alt_usxgmii_phy::get_dpi_libraries "$QSYS_SIMDIR"]]
