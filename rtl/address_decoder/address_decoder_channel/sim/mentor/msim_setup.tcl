...
# ----------------------------------------
# ACDS 23.4 79 win32 2024.02.13.12:01:28
...
alias file_copy {
  ...
  set normalized_src [address_decoder_channel::normalize_path "$file"]
  set normalized_dest [address_decoder_channel::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [address_decoder_channel::get_dpi_libraries "$QSYS_SIMDIR"]]
