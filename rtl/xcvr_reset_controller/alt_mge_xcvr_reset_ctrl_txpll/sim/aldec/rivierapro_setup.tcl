...
alias file_copy {
  ...
  set normalized_src [alt_mge_xcvr_reset_ctrl_txpll::normalize_path "$file"]
  set normalized_dest [alt_mge_xcvr_reset_ctrl_txpll::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [alt_mge_xcvr_reset_ctrl_txpll::get_dpi_libraries "$QSYS_SIMDIR"]]
