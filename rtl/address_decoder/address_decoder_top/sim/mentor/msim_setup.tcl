...
alias file_copy {
  ...
  set normalized_src [address_decoder_top::normalize_path "$file"]
  set normalized_dest [address_decoder_top::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [address_decoder_top::get_dpi_libraries "$QSYS_SIMDIR"]]
