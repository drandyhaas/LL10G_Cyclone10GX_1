...
`timescale 1 ns / 1 ns
module address_decoder_top_mm_clock_crossing_bridge_mm_ccb_1921_lcsq4ni 
#(
...
(
    ...
    address_decoder_top_mm_clock_crossing_bridge_mm_ccb_st_dc_fifo_1921_c5maiwy #(
        .SYMBOLS_PER_BEAT (1),
   ...
   endgenerate
    ...
    // --------------------------------------
    (* altera_attribute = "-name ALLOW_ANY_RAM_SIZE_FOR_RECOGNITION ON" *) 
    address_decoder_top_mm_clock_crossing_bridge_mm_ccb_st_dc_fifo_1921_ed7rbdy #(
        .SYMBOLS_PER_BEAT   (1),
