...
# ----------------------------------------
# If address_decoder_top_mm_clock_crossing_bridge is one of several IP cores in your
...
# ----------------------------------------
# ACDS 23.4 79 win32 2024.02.13.12:01:54
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "address_decoder_top_mm_clock_crossing_bridge.address_decoder_top_mm_clock_crossing_bridge"
}
...
append ELAB_OPTIONS [subst [address_decoder_top_mm_clock_crossing_bridge::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [address_decoder_top_mm_clock_crossing_bridge::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [address_decoder_top_mm_clock_crossing_bridge::get_memory_files "$QSYS_SIMDIR"]]
  ...
  set normalized_src [address_decoder_top_mm_clock_crossing_bridge::normalize_path "$file"]
  set normalized_dest [address_decoder_top_mm_clock_crossing_bridge::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [address_decoder_top_mm_clock_crossing_bridge::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [address_decoder_top_mm_clock_crossing_bridge::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [address_decoder_top_mm_clock_crossing_bridge::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [address_decoder_top_mm_clock_crossing_bridge::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
