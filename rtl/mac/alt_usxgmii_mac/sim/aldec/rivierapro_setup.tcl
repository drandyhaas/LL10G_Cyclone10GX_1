...
# ACDS 23.4 79 win32 2024.02.13.11:57:39
# ----------------------------------------
...
alias file_copy {
  ...
  set normalized_src [alt_usxgmii_mac::normalize_path "$file"]
  set normalized_dest [alt_usxgmii_mac::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [alt_usxgmii_mac::get_dpi_libraries "$QSYS_SIMDIR"]]
